...
function approveRequestContactReceived() {
    $(".user-approve-request-contact-received").unbind("click").on("click", function() {
        ...
        let targetName = $(this).parent().find("div.user-name>p").text().trim(); // trim: cat het khoang trong
        let targetAvatar = $(this).parent().find("div.user-vatar>img").attr("src");
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success) {
                    ...
                    decreaseNumberNotifContact("count-request-contact-received"); // js/calculateNoifContact.js
                    increaseNumberNotifContact("count-contacts"); // js/calculateNoifContact.js
...
socket.on("response-approve-request-contact-received", function(user) {
    ...
    decreaseNumberNotifContact("count-request-contact-sent"); // js/calculateNoifContact.js
    increaseNumberNotifContact("count-contacts"); // js/calculateNoifContact.js
