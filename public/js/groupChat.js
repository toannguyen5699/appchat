  ...
  $("#btn-create-group-chat").unbind("click").on("click", function() {
    ...
    Swal.fire({
      ...
      $.post("/group-chat/add-new", {
        ...
        // Step 01: hide modal tao mot cuoc tro chuyen
        ...
        <div class="right tab-pane" data-chat="${data.groupChat._id}" id="to_${data.groupChat._id}">
                <div class="top">
                    ...
                    <span class="chat-menu-right">
                        <a href="javascript:void()" class="number-members" data-toggle="modal">
                    ...
                    <span class="chat-menu-right">
                        <a href="javascript:void()" class="number-messages" data-toggle="modal">
...
$(document).ready(function() {
  ...
  socket.on("response-new-group-created", function(response) {
    // Step 01: hide modal tao mot cuoc tro chuyen : ko code
    ...
    // Step 08: Emit new group created: ko code
