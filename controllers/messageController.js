...
let addNewAttachment = (req,res) => {
	attachmentMessageUploadFile(req, res, async (error) => {
		...
		try {
			...
			// Remove attachment, because this attactment is saved to mongodb
...
let readMoreAllChat = async (req,res) => {
	try {
		...
		let leftSideData = await renderFile("views/main/readMoreConversations/_leftSide.ejs", dataToRender);
		let rightSideData = await renderFile("views/main/readMoreConversations/_rightSide.ejs", dataToRender);
		let imageModalData = await renderFile("views/main/readMoreConversations/_imageModal.ejs", dataToRender);
		let attachmentModalData = await renderFile("views/main/readMoreConversations/_attachmentModal.ejs", dataToRender);
...
let readMore = async (req,res) => {
	try {
		...
		let rightSideData = await renderFile("views/main/readMoreMessages/_rightSide.ejs", dataToRender);
		let imageModalData = await renderFile("views/main/readMoreMessages/_imageModal.ejs", dataToRender);
		let attachmentModalData = await renderFile("views/main/readMoreMessages/_attachmentModal.ejs", dataToRender);
